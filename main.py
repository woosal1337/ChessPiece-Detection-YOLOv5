# -*- coding: utf-8 -*-
"""Copy of Chess Detection and Training using Roboflow-Custom-YOLOv5

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ojd49uBYQ8f_YTqnp_zvof2YyARJ3mHQ
...
In this tutorial, we will walk through the steps required to train YOLOv5 on your custom objects. We use a [public chess piece detection dataset](https://public.roboflow.ai/object-detection/bccd), which is open source and free to use. You can also use this notebook on your own data.
...
[Augmented Startups](https://www.augmentedstartups.com) creates video tutorials in Artificial Intelligence, Computer Vision, Augmented Reality and Raspberry Pi. With over 78K+ subscribers we provide training in Object Detection, Object Tracking, Pose Estimation and Accelerated Embbeded Computer Vision.
...
# %cd /content
!curl -L "<YOUR_CURL_LINK>" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
...
--Team [Roboflow](https://roboflow.ai) in Collaboration with Augmented Startups
